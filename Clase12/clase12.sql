...
select idPlaylist as 'Id Playlist'  , idusuario as 'Id Usuario',titulo as Titulo, cantcanciones as 'Cant Canciones', idestado as'Id Estado', Fechacreacion as 'Fecha creación', Fechaeliminada as 'Fecha eliminada' from playlist order by cantcanciones desc limit 1;
