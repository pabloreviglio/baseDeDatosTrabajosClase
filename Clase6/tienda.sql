...
--
-- Table structure for table `pedido_x_producto`
--

DROP TABLE IF EXISTS `pedido_x_producto`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `pedido_x_producto`
--

LOCK TABLES `pedido_x_producto` WRITE;
/*!40000 ALTER TABLE `pedido_x_producto` DISABLE KEYS */;
/*!40000 ALTER TABLE `pedido_x_producto` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `producto` (
  `id` int NOT NULL AUTO_INCREMENT,
  `productocol` varchar(50) NOT NULL,
...
-- Dump completed on 2022-03-05 11:01:03
